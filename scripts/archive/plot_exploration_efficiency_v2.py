...
files = {
    ...
    "LAGRPO (G=8)": "grpo_B4_G8_metrics.csv"  # The manual run you just completed
}
...
axes[0].set_title("Training Success Rate Convergence")
...
axes[1].set_title("Response Length (Token Usage)")
...
axes[2].set_title("Exploration Efficiency")
...
save_path = os.path.join(plot_dir, 'exploration_efficiency_academic_v2.png')
